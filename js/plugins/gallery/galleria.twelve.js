...
( function( window, factory ) {
    ...
    Galleria.addTheme({
        ...
        defaults: {
            ...
            _locale: {
                show_thumbnails: 'Exibir Fotos',
                hide_thumbnails: 'Ocultar Fotos',
                play: 'Play',
                pause: 'Pause',
                enter_fullscreen: 'Tela Inteira',
                exit_fullscreen: 'Fechar',
                popout_image: 'Expandir imagem',
                showing_image: 'Exibindo imagem %s de %s'
            },
